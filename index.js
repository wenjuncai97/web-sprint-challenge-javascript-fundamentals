...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// The nestedFunction can access the variable internal because of closure. Since nestedFunction is nested within the parent function myFunction, it is able to access the variable internal by reaching outward, the process of closure, and grabbing its value.
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(){
    const allLower = zooAnimals.map((animal) => {
  ...
  */
  ...
  function lowPopulationAnimals(){
    const lessPopulation = zooAnimals.filter(item => item.population < 5);
